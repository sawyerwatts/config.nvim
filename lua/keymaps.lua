...
vim.keymap.set('n', '<leader>l', '<cmd>vs<cr><C-W><C-W>', { desc = '"Move" curr buffer in new vsplit' })
vim.keymap.set('n', '<leader>j', '<cmd>split<cr><C-W><C-W>', { desc = '"Move" curr buffer in new split' })

...
```
git clone https://github.com/sawyerwatts/config.nvim.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone https://github.com/sawyerwatts/config.nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
